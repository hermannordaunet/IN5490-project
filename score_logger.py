...
SCORES_CSV_PATH = "./scores/selection/scores.csv"
SCORES_PNG_PATH = "./scores/selection/scores.png"
SOLVED_CSV_PATH = "./scores/selection/solved.csv"
SOLVED_PNG_PATH = "./scores/selection/solved.png"
...
class ScoreLogger:
    def __init__(self, env_name, path):
        ...
        self.csv_path = "./scores/fast_plot/"+name+".csv"
        self.png_path = "./scores/fast_plot/"+name+".png"
